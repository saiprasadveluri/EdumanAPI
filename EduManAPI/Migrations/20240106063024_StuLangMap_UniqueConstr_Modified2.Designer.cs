...
namespace EduManAPI.Migrations
{
    ...
    [Migration("20240106063024_StuLangMap_UniqueConstr_Modified2")]
    partial class StuLangMap_UniqueConstr_Modified2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduManAPI.Bill", b =>
                {
                    b.Property<Guid>("BID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduManAPI.BillLineItem", b =>
                {
            ...
            modelBuilder.Entity("EduManAPI.LanguageMaster", b =>
                {
            ...
            modelBuilder.Entity("EduManAPI.PettyExpnse", b =>
                {
                    b.Property<Guid>("PEID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ChequeOrRefNo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EduManAPI.ServiceOrProduct", b =>
                {
                    b.Property<Guid>("PID")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EduManAPI.StudentInfo", b =>
                {
                    ...
                    b.Property<byte[]>("StuFatherImage")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("StuFatherImageMimeType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<byte[]>("StuMotherImage")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("StuMotherImageMimeType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<byte[]>("StudentImage")
                        .HasColumnType("varbinary(max)");

                    b.Property<string>("StudentImageMimeType")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EduManAPI.StudentLangMap", b =>
                {
                    b.Property<Guid>("MapId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("LangOrdinal")
                        .HasColumnType("int");

                    b.Property<Guid>("LanguageId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("StudentStnAcdMapId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("StudentStnAcdMapId", "LangOrdinal")
                        .IsUnique();

                    b.HasIndex("StudentStnAcdMapId", "LanguageId")
                        .IsUnique();

                    b.ToTable("studentLangMaps");
                });
            ...
            modelBuilder.Entity("EduManAPI.Bill", b =>
                {
                    b.HasOne("EduManAPI.ExpenseHead", "Exp")
                        .WithMany()
            ...
            modelBuilder.Entity("EduManAPI.BillLineItem", b =>
                {
                    b.HasOne("EduManAPI.Bill", "bill")
                        .WithMany()
                        .HasForeignKey("BID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduManAPI.ServiceOrProduct", "Prod")
                        .WithMany()
                        .HasForeignKey("ProdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduManAPI.Tax", "tax")
                        .WithMany()
                        .HasForeignKey("TaxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduManAPI.PettyExpnse", b =>
                {
                    b.HasOne("EduManAPI.BankDeatail", "BankDet")
                        .WithMany()
                        .HasForeignKey("AccountTypeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduManAPI.ExpenseHead", "ExpHead")
                        .WithMany()
                        .HasForeignKey("EHeadID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EduManAPI.StudentLangMap", b =>
                {
                    b.HasOne("EduManAPI.LanguageMaster", "Language")
                        .WithMany()
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduManAPI.StuStdAcdYearMap", "StudentStnAcdMapEntry")
                        .WithMany()
                        .HasForeignKey("StudentStnAcdMapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Language");

                    b.Navigation("StudentStnAcdMapEntry");
                });
